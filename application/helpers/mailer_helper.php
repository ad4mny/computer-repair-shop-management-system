...
if (is_file(VENDORPATH . 'ivantcholakov/codeigniter-phpmailer/helpers/mailer_helper.php')) {
    require_once VENDORPATH . 'ivantcholakov/codeigniter-phpmailer/helpers/mailer_helper.php';
}
