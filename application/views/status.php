        ...
        <div class="row row-cols-1 row-cols-md-3 g-3 m-3 border-start border-2 ">
            ...
            if (is_array($request) && !empty($request)) {
                foreach ($request as $row) {
                    echo '<div class="col">';
                    echo '<div class="card text-white  bg-primary shadow rounded-lg border position-relative h-100">';
                    ...
                    echo '<a href="' . base_url() . 'dashboard/view/' . $this->encryption->encrypt($row['rsd_id']) . '" class="position-absolute top-0 end-0 m-2"><span class="fa-stack fa-lg "><i class="fa fa-circle fa-stack-2x text-info" ></i><i class="fa fa-eye fa-stack-1x text-white"></i></span></a>';
                    echo '</div>';
