    ...
    <div class="container p-5 " id="content">
        ...
        <div class="row">
            <div class="col mt-3 mx-3">
                <p>All registered customer in the system</p>
            </div>
        </div>
        ...
        <div class="row mx-3 text-muted">
            ...
            <div class="col-3 text-capitalize"><small>LOCATION</small></div>
        ...
        ?>
                <div class="row mx-3 mb-1 py-2 shadow-sm bg-white rounded-3">
                    ...
                    <div class="col-3 text-capitalize m-auto"> <?php echo $row['cd_city'] . ', ' . $row['cd_state']; ?></div>
                    <div class="col-2 text-capitalize m-auto"> <?php echo $row['cd_phone']; ?></div>
