  ...
  <nav id="sidebar">
      ...
      <ul class="list-unstyled components">
          <li class="<?php if ($this->uri->segment(1) == 'dashboard') echo 'active'; ?>"><a href="<?php echo base_url(); ?>dashboard"><i class="fas fa-columns fa-sm fa-fw me-2"></i> Dashboard</a></li>
          <li class="<?php if ($this->uri->segment(1) == 'request') echo 'active'; ?>"><a href="<?php echo base_url(); ?>request"><i class="fas fa-clipboard-list fa-sm fa-fw me-2"></i> Request</a></li>
          <li class="<?php if ($this->uri->segment(1) == 'status') echo 'active'; ?>"><a href="<?php echo base_url(); ?>status"><i class="fas fa-tasks fa-sm fa-fw me-2"></i> Status</a></li>
          <li class="<?php if ($this->uri->segment(1) == 'track') echo 'active'; ?>"><a href="<?php echo base_url(); ?>track"><i class="fas fa-map-marker-alt fa-sm fa-fw me-2"></i> Track</a></li>
