<div class="wrapper">
    <div class="container p-5" id="content">
        ...
        <form method="post" action="<?php echo base_url(); ?>requestController/add_new_request">
            <div class="row mx-3 mb-5 border-start border-2">
                <div class="col-5">
            ...
            <div class="row">
                <div class="col-10 text-end fixed-bottom pb-5">
                    ...
                    <button type="submit" class="btn btn-primary" name="submit" value="submit">CONFIRM <i class="fas fa-chevron-right fa-fw"></i></button>
                </div>
            </div>
        </form>
    </div>
